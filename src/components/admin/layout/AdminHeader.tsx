        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-acr-gray-200">
            <div className="space-y-3">
              ...
              <button
                onClick={handleLogout}
                className="flex items-center gap-2 px-3 py-3 w-full text-left text-sm font-medium text-red-600 hover:text-red-800 hover:bg-red-50 rounded-md transition-all duration-200"
              >
                <LogOut className="w-4 h-4" />
                Logout
              </button>
