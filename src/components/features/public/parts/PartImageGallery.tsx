  ...
  return (
    <div className={`${className} bg-white p-4`}>
      <div className="flex flex-col gap-4">
        ...
        {/* Bottom Thumbnails - Horizontal Strip with scroll (All screen sizes) */}
        {showThumbnails && (
          <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-acr-gray-300 scrollbar-track-acr-gray-100">
              ...
              <button
                ...
                className={`relative flex-shrink-0 overflow-hidden transition-all ${
                  viewMode === "photo" && idx === photoIndex
                    ? "border-2 border-acr-gray-900 ring-2 ring-acr-gray-900"
