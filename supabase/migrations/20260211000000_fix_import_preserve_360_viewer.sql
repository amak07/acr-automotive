-- =====================================================
-- Migration: Remove 360 viewer fields from import function
-- =====================================================
-- The execute_atomic_import() function was overwriting
-- has_360_viewer and viewer_360_frame_count on every
-- Excel import, resetting values set via the admin UI.
--
-- Fix: Remove these fields from INSERT (new parts will
-- use DB defaults: false / 0) and UPDATE (existing
-- values are preserved).
--
-- The ImportService.ts payload already excludes these
-- fields; this migration aligns the SQL function.
-- =====================================================
...
BEGIN
  ...
  -- New parts use DB defaults (false / 0). These fields are managed
  -- exclusively via the admin UI 360 viewer upload.
  ...
  -- Note: has_360_viewer and viewer_360_frame_count are NOT included.
  -- Existing values are preserved — these fields are managed exclusively
  -- via the admin UI 360 viewer upload.
