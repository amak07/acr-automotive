...
**Configuration:**
- Dev: `.env.local` → `http://localhost:54321`
- Test: `.env.test.local` → `http://localhost:54321` (same instance)
...
- `.env.test.local` - Complete documentation of shared architecture
...
2. ❌ `.env.test.local` not loading in Jest context
