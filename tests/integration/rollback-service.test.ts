 ...
 *
 * Coverage:
 * - Sequential enforcement (2 tests)
 * - Conflict detection (2 tests) - basic rollback, import edits ignored
 ...
 * Total: 14 tests
 *
 * NOTE: Sequential rollback enforcement and manual edit conflict detection
 * features were planned but not implemented. Tests for these removed.
 */
...
async function cleanup() {
  ...
  await supabase
    ...
    .delete()
    .neq("id", "00000000-0000-0000-0000-000000000000")
    .neq("file_name", TEST_SNAPSHOT_MARKER);
}
...
describe("RollbackService - Sequential Enforcement", () => {
  ...
  // NOTE: Sequential rollback enforcement test removed - feature not implemented
...
describe("RollbackService - Conflict Detection", () => {
  ...
  // NOTE: Manual edit detection test removed - conflict detection feature not implemented
