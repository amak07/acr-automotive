...
|---|-------------|--------|---------------------|--------|
| 1 | Search / Finder improvements | ✅ Implement | Phase 4A | 1-2 days |
| 2 | User Management (roles, auth, password change) | ✅ Implement | Phase 1 | 3-4 days |
| 3 | Database review & optimization | ✅ Implement | Phase 2B | 1 day |
| 4a | Excel - Image URL management (ML-style workflow) | ✅ Implement | Phase 3B | 2-3 days |
| 4b | Excel - Cross-reference brands (11 explicit columns) | ✅ Implement | Phase 3A | 1-2 days |
| 4c | Excel - ACR brand handling | ⏭️ Skip | N/A | Skipped |
| 5 | Export / Delete issues (partial delete bug) | ✅ Implement | Phase 2A | 1 day |
| 6 | Images & SKUs linking | ✅ Verify | Phase 4C | 0.5 day |
| 7 | Parts & Cross-references merge | ✅ Implement | Phase 4B | 0.5 day |
| 8 | Mobile / Tablet optimization (floating buttons) | ✅ Implement | Phase 4D | 0.5 day |
...
## PHASE 2: Database Optimization & Bug Fixes (2-3 days)
...
## PHASE 3: Excel Enhancements (3-4 days)
...
row.National_SKUs = groupCrossRefsByBrand(part.cross_references, 'National') || '';
...
function parseCrossReferences(row: ExcelPartRow, partId: string): CrossReference[] {
...
## PHASE 4: UI/UX & Search Improvements (2-3 days)
...
**Current Behavior**:
```tsx
<div className="fixed bottom-4 right-4 z-50"> {/* Positioned from viewport */}
  {/* Buttons */}
</div>
```
